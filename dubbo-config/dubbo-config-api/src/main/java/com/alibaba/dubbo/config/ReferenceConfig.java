...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            // 引用服务，返回 Invoker 对象
            //调用链 ProtocolFilterWrapper.refer() -> ProtocolListenerWrapper.refer() -> InjvmProtocol.refer()
            ...
            if (urls.size() == 1) {
                //refer调用链：ProtocolFilterWrapper.refer() -> ProtocolListenerWrapper.refer() -> RegistryProtocol.refer() -> DubboProtocol.refer()
